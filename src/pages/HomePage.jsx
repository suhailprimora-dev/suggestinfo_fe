  ...
  return (
    <div className="w-full font-sans overflow-hidden">
      ...
      <section className="py-16 px-4 md:px-8 lg:px-12 bg-white relative">
        <div className="w-full relative border border-[#179b9b] rounded-[60px] p-8 lg:py-20 lg:px-20 shadow-[0_20px_60px_rgba(23,155,155,0.35)] bg-white">
          ...
          <div className="grid lg:grid-cols-12 gap-10 items-center">
            ...
            >
              <div className="inline-block px-10 py-6 bg-[#0a1e27] text-white text-[20px] font-bold uppercase tracking-wider rounded-full mb-6">
                WHY CHOOSE US
              </div>
              <h2 className="text-3xl md:text-4xl font-bold text-[#0a1e27] leading-tight mb-10">
                Sky Rocket Your Business With Suggestinfo
              </h2>

              <div className="space-y-8 mb-10">
                <div className="flex gap-4 items-start">
                  <img src={RocketLaunchIcon} alt="Rocket" className="w-7 h-7 object-contain mt-8 shrink-0" />
                  <p className="text-[#0a1e27] text-[18px] font-medium leading-relaxed">
      ...
      <section className="py-24 relative bg-[#0a1e27] overflow-hidden min-h-[700px] flex flex-col justify-center">
        ...
        <div className="relative z-10 flex flex-col items-center w-full max-w-7xl mx-auto px-6">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="relative w-full max-w-[750px] border border-white/20 bg-[#ffffff08] backdrop-blur-[20px] rounded-[32px] p-10 md:px-20 md:py-16 shadow-[0_30px_60px_rgba(0,0,0,0.5)] flex flex-col items-center text-center"
          >
