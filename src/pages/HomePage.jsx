  ...
  return (
    <div className="w-full font-sans overflow-hidden">
      ...
      <section className="py-8 px-[4px] md:px-[6px] overflow-hidden bg-white relative">
        <div className="w-full relative border border-[#0d5c46] rounded-[50px] md:rounded-[60px] px-8 py-8 md:px-14 md:py-10 lg:py-12 lg:px-20 shadow-[inset_0_2px_10px_rgba(0,0,0,0.8)] bg-white">
