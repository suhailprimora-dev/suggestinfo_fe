      ...
      <section className="bg-white py-20 relative overflow-hidden">
        ...
        <div className="max-w-screen-xl mx-auto px-10 relative z-10">
          ...
          >
            <motion.div
              variants={fadeUp}
              className="service-card bg-white border border-gray-100 rounded-2xl p-6 flex flex-col shadow-[0_25px_60px_rgba(0,0,0,0.32)] hover:shadow-[0_40px_80px_rgba(0,0,0,0.45)] hover:-translate-y-2.5 transition-all duration-150"
            >
              {/* Icon Container */}
              <div className="w-16 h-16 mb-5 bg-white border border-slate-100 rounded-xl flex items-center justify-center shadow-[0_8px_20px_rgba(0,0,0,0.06)] flex-shrink-0 overflow-hidden">
                <img
                  src={icon1}
            ...
            <div className="flex justify-center gap-2.5 items-center">
              {testimonials.map((_, i) => (
                <button
                  ...
                  className={`rounded-full transition-all duration-300 bg-transparent cursor-pointer ${
                    activeT === i
