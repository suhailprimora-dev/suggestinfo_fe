      ...
      <section style={{ backgroundColor: '#e8f8f5' }} className="pt-16 pb-12 text-center relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-6 relative z-10">
          <motion.div initial="hidden" animate="visible" variants={fadeUp}>
            <p className="text-[24px] text-black font-extrathin uppercase  mb-4">
              ABOUT US
            </p>
            <div className="w-full">
              <h1 className="text-center text-[#080808] font-['Poppins',sans-serif] text-[43px] font-bold leading-[66px] mb-3">
                Specializing in creative digital marketing <br /> and web development</h1>
            </div>
        ...
        <motion.div
          ...
          className="w-full max-w-[120px] mx-auto px-6 relative z-10 pb-8"
        >
          <img
            src={heroImg}
