        ...
        <div className="max-w-screen-xl mx-auto px-10 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              variants={fadeUp}
              className="w-full lg:-ml-6"
            >
              <p className="text-[17px] font-regular text-[#3cc994] font-['poppins',sans-serif] tracking-[0.1em] uppercase mb-2">
              ...
              <p className="text-[15px] text-white/95 leading-relaxed tracking-[0.035em] mb-4 font-['poppins',sans-serif]">
              ...
              <p className="text-[16px] text-white/95 leading-relaxed tracking-[0.035em] mb-4 font-['poppins',sans-serif]">
              ...
              <p className="text-[16px] text-white/95 leading-relaxed tracking-[0.035em] font-['poppins',sans-serif]">
