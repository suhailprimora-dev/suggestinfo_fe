          ...
          >
            {wcuItems.map((item, i) => (
              <motion.div
                key={i}
                variants={fadeUp}
                className="border border-gray-100 rounded-2xl p-6 lg:p-7 flex items-center gap-6 lg:gap-8 bg-white shadow-[0_8px_25px_rgba(0,0,0,0.1)] hover:shadow-[0_12px_35px_rgba(0,0,0,0.15)] hover:-translate-y-1 transition-all duration-300"
              >
