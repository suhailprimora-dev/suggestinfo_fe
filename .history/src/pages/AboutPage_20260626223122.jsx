      ...
      <section className="bg-white py-20 relative overflow-hidden">
        ...
        <div className="w-full px-6 relative z-10">
          ...
          <h2 className="text-left leading-tight mb-12 font-['Poppins',sans-serif]">
            <span className="block text-[25px]  font-regular text-black mb-1">Clients Review</span>
            <span className="block text-[40px] font-semibold font-['Poppins',sans-serif] text-[#279B89]">What Our Client's Say</span>
          </h2>
