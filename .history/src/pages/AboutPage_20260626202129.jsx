      ...
      <section className="bg-white py-20 relative overflow-hidden">
        ...
        <div className="max-w-screen-xl mx-auto px-10 grid grid-cols-1 lg:grid-cols-12 gap-14 items-start relative z-10">
          ...
          <motion.div
            ...
            variants={fadeUp}
          >
            <p className="text-[18px] font-semibold  text-[#002F32] uppercase tracking-wide mb-3">
              WHY CHOOSE US
            </p>
            ...
            <p className="text-[15px] text-[#4b5563] leading-relaxed mb-10 w-full">
          ...
          >
            {wcuItems.map((item, i) => (
              <motion.div
                key={i}
                variants={fadeUp}
                className="border border-black rounded-2xl p-6 lg:p-7 flex items-center gap-6 lg:gap-8 bg-white shadow-[0_8px_25px_rgba(0,0,0,0.1)] hover:shadow-[0_12px_35px_rgba(0,0,0,0.15)] hover:-translate-y-1 transition-all duration-300"
              >
      ...
      <section className="bg-white py-20 relative overflow-hidden">
        ...
        <div className="max-w-screen-xl mx-auto px-10 relative z-10">
          ...
          <h2 className="text-3xl lg:text-[42px] font-['Poppins',sans-serif] font-[800] text-[#3b3663] leading-tight mb-16 text-center">
            <span className="block font-['Poppins',sans-serif] text-[#3b3663]">Clients Review</span>
            <span className="block font-['Poppins',sans-serif] text-[#3cc994] italic mt-1">What Our Client&apos;s Say</span>
          </h2>
