  ...
  return (
    <div className="w-full font-sans overflow-hidden">
      ...
      <section className="py-8 px-2 md:px-4 lg:px-6 overflow-hidden bg-white relative">
        <div className="w-max-1900px relative border border-[#179b9b] rounded-[40px] md:rounded-[50px] px-6 py-8 md:px-12 md:py-10 lg:py-12 lg:px-16 shadow-[0_20px_60px_rgba(23,155,155,0.35)] bg-white">
