      ...
      <section className="bg-white py-20 relative overflow-hidden">
        ...
        <div className="w-full px-6 relative z-10">
          <div className="mb-3 text-left">
            <span className="inline-block text-[12px] font-bold tracking-[2px] text-gray-700 uppercase border border-gray-200 rounded-full px-4 py-1 bg-white shadow-sm font-['Poppins',sans-serif]">
              TESTIMONIALS
            </span>
          </div>
          <h2 className="text-left leading-tight mb-12 font-['Poppins',sans-serif]">
            <span className="block text-[30px] lg:text-4xl font-[500] text-black mb-1">Clients Review</span>
            <span className=" text-4xl lg:text-[50px] font-[700] text-[#279B89]">What Our Client's Say</span>
          </h2>
