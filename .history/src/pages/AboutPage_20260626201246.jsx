...
export function AboutPage() {
  ...
  return (
    <div className="w-full bg-white text-[#696687] font-['Nunito',sans-serif] text-[18px] font-normal leading-[27px] selection:bg-[#6254e7] selection:text-white">
      ...
      <section style={{ backgroundColor: '#e8f8f5' }} className="pt-16 pb-12 text-center relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <motion.div initial="hidden" animate="visible" variants={fadeUp}>
            ...
            <p className="text-[15px] md:text-[17px] text-[#15803d] font-medium font-['Nunito',sans-serif] mb-5 max-w-3xl mx-auto">
      ...
      <section className="bg-white py-20 relative overflow-hidden">
        ...
        <div className="max-w-screen-xl mx-auto px-10 relative z-10">
          ...
          <div className="text-center mb-14">
            ...
            <p className="text-[22px] text-gray-900 font-['Nunito',sans-serif]">
          ...
          >
            ...
            >
              ...
              {/* Title — Poppins */}
              <h3 className="text-[20px] font-bold text-[#3cc994] mb-3 leading-snug font-['Poppins',sans-serif]">
                Custom Website Development
              </h3>

              {/* Description — Nunito */}
              <p className="text-[14px] text-gray-500 leading-relaxed mb-7 flex-1 font-['Nunito',sans-serif]">
              ...
              <a
                href="/services"
                className={`${gradientBtn} text-[14px] px-6 py-2.5 justify-center self-start w-fit font-['Poppins',sans-serif]`}
                style={gradientStyle}
              >
                Learn More
              </a>
        ...
        <div className="max-w-screen-xl mx-auto px-10 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            >
              ...
              <p className="text-[15px] text-white leading-relaxed tracking-[0.035em] mb-4 font-['Nunito',sans-serif]">
              ...
              <p className="text-[15px] text-white leading-relaxed tracking-[0.035em] font-['Nunito',sans-serif]">
            ...
            >
              ...
              <div className="flex justify-center">
                <a
                  href="/services"
                  className={`${gradientBtn} text-[14px] px-7 py-2.5 font-['Poppins',sans-serif]`}
                  style={gradientStyle}
                >
      ...
      <section className="bg-white py-20 relative overflow-hidden">
        ...
        <div className="max-w-screen-xl mx-auto px-10 grid grid-cols-1 lg:grid-cols-12 gap-14 items-start relative z-10">
          ...
          <motion.div
            ...
            variants={fadeUp}
          >
            <p className="text-[16px] font-bold text-[#002F32] uppercase tracking-wide mb-3 font-['Poppins',sans-serif]">
              WHY CHOOSE US
            </p>
            <h2 className="text-[28px] lg:text-[34px] font-['Poppins',sans-serif] font-[800] text-[#0a0a0a] leading-[1.3] w-full mb-5">
              Save Time &amp; Effort With The Suggestinfo
            </h2>
            <p className="text-[15px] text-[#4b5563] leading-relaxed mb-10 w-full font-['Nunito',sans-serif]">
            ...
            <a
              href="/contact"
              className={`${gradientBtn} text-[14px] px-7 py-2.5 rounded-lg font-bold font-['Poppins',sans-serif]`}
              style={gradientStyle}
            >
              CONTACT US &rarr;
            </a>
          ...
          >
            {wcuItems.map((item, i) => (
              <motion.div
                key={i}
                variants={fadeUp}
                className="border border-[#e5e7eb] rounded-2xl p-6 lg:p-7 flex items-center gap-6 lg:gap-8 bg-white shadow-[0_0_35px_rgba(93,198,123,0.15)] hover:shadow-[0_0_40px_rgba(93,198,123,0.25)] hover:-translate-y-1 transition-all duration-300"
              >
                ...
                <div className="flex-1">
                  <h3 className="text-[20px] font-[700] mb-2 text-[#5dc67b] font-['Poppins',sans-serif]">{item.title}</h3>
                  <p className="text-[14px] text-[#4b5563] leading-relaxed font-['Nunito',sans-serif]">{item.desc}</p>
                </div>
              </motion.div>
            ))}
          </motion.div>
      ...
      <section className="bg-white py-20 relative overflow-hidden">
        ...
        <div className="max-w-screen-xl mx-auto px-10 relative z-10">
          <div className="mb-4 text-center">
            <span className="inline-block text-[11px] font-bold tracking-[2px] text-gray-400 uppercase border border-gray-200 rounded-full px-4 py-1 bg-white shadow-sm font-['Poppins',sans-serif]">
              TESTIMONIALS
            </span>
          </div>
          <h2 className="text-3xl lg:text-[42px] font-['Poppins',sans-serif] font-[800] text-[#3b3663] leading-tight mb-16 text-center">
            <span className="block text-[#3b3663]">Clients Review</span>
            <span className="block text-[#3cc994] italic mt-1 font-['Nunito',sans-serif]">What Our Client&apos;s Say</span>
          </h2>
          ...
          >
            ...
            <p className="text-[18px] text-gray-600 leading-relaxed text-center mb-8 max-w-3xl mx-auto font-normal font-['Nunito',sans-serif]">
              {testimonials[activeT].text}
            </p>
            <div className="text-center mb-8">
              <p className="text-[17px] font-bold text-gray-800 mb-1 font-['Poppins',sans-serif]">{testimonials[activeT].author}</p>
              <p className="text-[14px] text-gray-400 font-medium font-['Nunito',sans-serif]">{testimonials[activeT].role}</p>
            </div>
