      ...
      <section className="bg-white py-20 relative overflow-hidden">
        ...
        <div className="w-full px-6 relative z-10">
          <div className="mb-3 text-left">
            <span className="inline-block text-[10px] font-regular   text-black uppercase border border-gray-100 rounded-full px-4 py-1 bg-white shadow-sm font-['Poppins',sans-serif]">
              TESTIMONIALS
            </span>
          </div>
