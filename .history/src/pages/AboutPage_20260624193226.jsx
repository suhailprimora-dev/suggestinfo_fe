      ...
      <section style={{ backgroundColor: '#e8f8f5' }} className="pt-16 pb-12 text-center relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-6 relative z-10">
          <motion.div initial="hidden" animate="visible" variants={fadeUp}>
            <p className="text-[18px] text-[#696687] font-medium uppercase tracking-[0.15em] mb-4">
              ABOUT US
            </p>
            <div className="px-[40px]">
              <h1 className="text-center text-[#080808] font-['Poppins',sans-serif] text-[44px] font-bold leading-[66px] mb-6 max-w-5xl mx-auto">
                Specializing in creative digital marketing and<br className="hidden md:block" /> web development
              </h1>
            </div>
            <p className="text-[16px] md:text-[18px] text-[#0ea5e9] font-medium mb-12 max-w-3xl mx-auto">
        ...
        <motion.div
          ...
          className="w-full max-w-[1100px] mx-auto px-6 relative z-10 pb-8"
        >
          <img
            src={heroImg}
