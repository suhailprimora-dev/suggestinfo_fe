        ...
        <div className="max-w-screen-xl mx-auto px-10 relative z-10">
          ...
          >
            ...
            <motion.div
              ...
              whileHover={{
                y: -10,
                boxShadow: "0 50px 70px rgba(50, 80, 85, 0.15)",
                borderColor: "rgba(60, 201, 148, 0.4)"
              }}
              transition={{ duration: 0.8, ease: [0.16, 1, 0.3, 1] }}
              className="service-card bg-white border border-slate-100 rounded-3xl pt-4 pb-6 px-6 flex flex-col shadow-[0_20px_50px_rgba(0,0,0,0.1)] cursor-pointer"
            >
              {/* Icon Container */}
            ...
            <motion.div
              ...
              whileHover={{
                y: -10,
                boxShadow: "0 50px 70px rgba(17, 19, 20, 0.15)",
                borderColor: "rgba(60, 201, 148, 0.4)"
              }}
              transition={{ duration: 0.8, ease: [0.16, 1, 0.3, 1] }}
              className="service-card bg-white border border-slate-100 rounded-3xl pt-4 pb-6 px-6 flex flex-col shadow-[0_20px_50px_rgba(0,0,0,0.1)] cursor-pointer"
