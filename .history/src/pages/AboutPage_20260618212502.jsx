      ...
      <section className="bg-white py-20 relative overflow-hidden">
        ...
        <div className="max-w-screen-xl mx-auto px-10 relative z-10">
          ...
          >
            ...
            <motion.div
              variants={fadeUp}
              className="service-card bg-white border border-slate-100 rounded-3xl p-6 flex flex-col "
            >
              {/* Icon Container */}
              <div className="w-24 h-24 mb-5 flex items-center justify-center flex-shrink-0 p-3.5">
                <img
            ...
            >
              {/* Icon Container */}
              <div className="w-24 h-24 mb-5 bg-[#3cc994]/8 border border-[#3cc994]/15 rounded-2xl flex items-center justify-center flex-shrink-0 p-3.5 ">
                <img
                  src={icon4}
