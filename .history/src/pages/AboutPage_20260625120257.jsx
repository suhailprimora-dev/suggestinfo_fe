        ...
        <div className="max-w-screen-xl mx-auto px-10 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <motion.div
              ...
              variants={fadeUp}
            >
              <p className="text-[19px] font-bold tracking-[3px] text-[#3cc994] font-['poppins',sans-serif]  uppercase mb-4">
              ...
              <p className="text-[17px] text-white leading-relaxed mb-5 font-['poppins',sans-serif] ">
              ...
              <p className="text-[15px] text-white leading-relaxed mb-5 font-['poppins',sans-serif] ">
              ...
              <p className="text-[15px] text-white leading-relaxed font-['poppins',sans-serif] ">
