        ...
        <div className="w-full pl-[45px] pr-6 relative z-10">
          ...
          >
            ...
            <div className="text-left mb-15">
              <h4 className="font-nunito-sans text-gray-900 font-extrabold text-center ml-[250px] text-[17px]">{testimonials[activeT].author}</h4>
              <p className="font-nunito-sans text-gray-500 text-[18px] text-center ml-[2800px] font-normal">{testimonials[activeT].role}</p>
            </div>
