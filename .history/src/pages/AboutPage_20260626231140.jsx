  ...
  return (
    <div className="w-full bg-white text-[#696687] font-['Poppins',sans-serif] text-[18px] font-normal leading-[27px] selection:bg-[#6254e7] selection:text-white">
            ...
            >
              ...
              <div className="w-24 h-24 mb-3 flex-shrink-0">
                <img
                  ...
                  className="max-w-[300pdx] h-full object-contain"
                />
              </div>
      ...
      <section className="bg-white py-20 relative overflow-hidden">
        ...
        {/* Animated sea wave at bottom - single smooth layer */}
        <div className="absolute bottom-0 left-0 right-0 h-[58%] z-0 overflow-hidden">
          <motion.div
            ...
            style={{ width: '200%' }}
          >
            <svg viewBox="0 0 2880 320" preserveAspectRatio="none" className="w-full h-full" style={{ fill: '#e8f8f5' }}>
              <path d="M0,160 C200,260 400,60 720,160 C1040,260 1240,60 1440,160 C1640,260 1840,60 2160,160 C2480,260 2680,60 2880,160 L2880,320 L0,320 Z" />
            </svg>
          </motion.div>
        </div>
        ...
        <div className="w-full pl-[45px] pr-6 relative z-10">
          ...
          <h2 className="text-left leading-tight mb-12 font-['Poppins',sans-serif]">
            <span className="block text-[27px]  font-regular text-black mb-4">Clients Review</span>
            <span className="block text-[42px] font-semibold font-[serif] text-[#279B89]">What Our Client's Say</span>
          </h2>
          ...
          <motion.div
            ...
            className="font-nunito relative w-full max-w-[835px] mx-auto border border-white/60 bg-white/60 backdrop-blur-md rounded-tl-[7px] rounded-br-[7px] rounded-tr-[70px] rounded-bl-[70px] pt-16 pb-12  md:px-16 shadow-[0_15px_40px_rgba(0,0,0,0.08)] flex flex-col items-start text-left min-h-[280px]"
          >
            ...
            <p className="font-nunito text-gray-700 text-[20px]  leading-[1.8] mb-2 font-light text-left w-full">
              {testimonials[activeT].text}
            </p>

            <div className="text-left mb-15">
              <h4 className="font-nunito-sans text-gray-600 font-extrabold text-center ml-[280px] text-[19px]">{testimonials[activeT].author}</h4>
              <p className="font-nunito-sans text-gray-500 text-[18px] text-center ml-[280px] font-regular">{testimonials[activeT].role}</p>
            </div>
