      ...
      <section className="bg-white py-20 relative overflow-hidden">
        ...
        <div className="w-full pl-[45px] pr-6 relative z-10">
          ...
          <motion.div
            ...
            className="font-nunito relative w-full max-w-[850px] mx-auto border border-gray-200 bg-white rounded-tl-[7px] rounded-br-[7px] rounded-tr-[70px] rounded-bl-[70px] pt-16 pb-12  md:px-16 shadow-[0_10px_40px_rgba(0,0,0,0.07)] flex flex-col items-start text-left min-h-[280px]"
          >
