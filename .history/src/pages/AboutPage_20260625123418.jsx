        ...
        <div className="max-w-screen-xl mx-auto px-10 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <motion.div
              ...
              variants={fadeUp}
            >
              <p className="text-[17px] font-regular  text-[#3cc994] font-['poppins',sans-serif]  uppercase mb-4">
                DIGITAL EXCELLENCE SIMPLIFIED
              </p>
              <h2 className="text-[28px] sm:text-4xl lg:text-[42px] xl:text-[46px] whitespace-nowrap font-['poppins',sans-serif] font-[800] text-white leading-tight mb-7">
                UAE Best Digital Agency
              </h2>
              <p className="text-[16px] text-white  mb-5 font-['poppins',sans-serif] ">
              ...
              <p className="text-[16px] text-white leading-relaxed mb-5 font-['poppins',sans-serif] ">
              ...
              <p className="text-[16px] text-white leading-relaxed font-['poppins',sans-serif] ">
            ...
            >
              <img
                ...
                className="w-full max-w-[500px] h-auto rounded-2xl object-cover shadow-2xl mx-auto lg:mx-0"
              />
