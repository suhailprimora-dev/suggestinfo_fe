      ...
      <section className="w-full min-h-[calc(100vh-114px)] relative bg-[#E7EFE2] flex flex-col lg:flex-row overflow-hidden">
        ...
        <div className="w-full lg:w-[68%] px-6 py-16 md:px-12 lg:pl-24 lg:pr-12 flex flex-col justify-center relative z-10">
          ...
          >
            ...
            {/* Heading */}
            <h2 className="text-3xl sm:text-4xl lg:text-[42px] xl:text-[50px]  leading-[1.15] mb-8 tracking-tight">
              <span className="text-[#1E886F] block mb-1 font-semibold">One-Stop Solution for</span>
              <span className="text-gray-900 block lg:whitespace-nowrap font-medium">Managing Human Resource in UAE</span>
            </h2>
