      ...
      <section className="bg-white py-20 relative overflow-hidden">
        ...
        <div className="w-full px-6 relative z-10">
          ...
          <h2 className="text-left leading-tight mb-12 font-['Poppins',sans-serif]">
            <span className="block text-[25px]  font-regular text-black mb-4">Clients Review</span>
            <span className="block text-[40px] font-semibold font-[serif] text-[#279B89]">What Our Client's Say</span>
          </h2>
          ...
          >
            ...
            <div className="absolute -top-0left-1/2 -translate-x-1/2 flex gap-1.5">
