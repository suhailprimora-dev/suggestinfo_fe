    ...
    <div className="w-full bg-white text-[#696687] font-['Poppins',sans-serif] text-[18px] font-normal leading-[27px] selection:bg-[#6254e7] selection:text-white">
      ...
      <section className="bg-white py-20 relative overflow-hidden">
        ...
        <div className="w-full pl-[45px] pr-6 relative z-10">
          ...
          <motion.div
           e rounded-br-none rounded-tr-[28px] rounded-bl-[28px] pt-16 pb-12 px-12 md:px-16 shadow-[0_10px_40px_rgba(0,0,0,0.07)] flex flex-col items-start text-left min-h-[280px]"
          >
